...
```{r echo=FALSE}
plot(qrcode::qr_code("https://gilmore-lab.github.io/hong-kong-polytech/"))
```

<https://gilmore-lab.github.io/hong-kong-polytech/>
...
- Disinterestedness (public not private benefit)
- Organized skepticism (subject to critical scrutiny)
:::
::: {.column width=40%}
...
- Internally reproducible workflows
    - Bolster confidence ("You are the easiest one to fool", [@Feynman1974-ld])
...
:::
::: {.column width=50%}
![Words 12-mo-olds know](https://play-project.org/KoBoToolbox/home-visit-viz_files/figure-html/18-eng-wordcloud-1.png)
:::
::::
...
- Share full protocols, iterate on, improve upon
